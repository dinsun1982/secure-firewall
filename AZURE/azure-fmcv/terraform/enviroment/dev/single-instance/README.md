<!-- BEGIN_TF_DOCS -->
# Deployment of Cisco Secure fmcv instances in Azure

## Overview

Using this Terraform template, one/two instance of fmcv will be deployed in  Azure in a new Vnet with the following components, 
...
Provisioning of fmcv servers in single AZs
